...
public class InitConfig {
    ...
    public CommandLineRunner initRolesAndFeatures(RoleRepository roleRepository,
        ...
        return args -> {
            ...
            featureToRoles.put("UPDATE_PASSWORD", List.of("Marketing", "Branch Manager", "Back Office"));
            featureToRoles.put("LOGOUT", List.of("Super Admin", "Marketing", "Branch Manager", "Back Office"));
            featureToRoles.put("GET_ALL_BRANCH", List.of("Super Admin"));
            featureToRoles.put("GET_BYID_BRANCH", List.of("Super Admin"));
            ...
            featureToRoles.put("CREATE_PENGAJUAN", List.of("Marketing", "Branch Manager", "Back Office"));
